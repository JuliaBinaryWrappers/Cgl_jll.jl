...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Cgl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3830e938-1dd0-5f3e-8b8e-b3ee43226782"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Cgl", artifacts_toml) for e in artifacts["Cgl"]]
...
if best_platform === nothing
    @debug("Unable to load Cgl; unsupported platform $(triplet(platform_key_abi()))")
else
